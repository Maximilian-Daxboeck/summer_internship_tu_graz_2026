...
def visualise_training_dataset(dataset: TensorDataset) -> plt.Figure:
    """
...
def visualise_optimisation_stats(loss_list: List[float]) -> plt.Figure:
    """
...
def visualise_samples(sample: torch.Tensor) -> plt.Figure:
    """
