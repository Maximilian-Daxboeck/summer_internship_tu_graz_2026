# My Summer Internship 2026 at TU Graz
My code files and summary for the summer internship 2026 on the following topics:
* Bayesian vs frequentist statistics, discrete naive Bayesian classifier (for an email spam filter as an application) and Bayesian linear regression (with template files)
